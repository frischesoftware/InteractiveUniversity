<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InvestmentDecisions.ascx.cs" Inherits="ControlPanel_small" %>
...
<div >
    ...
    <div class="grid_6 alpha three_product_boxes" style="background-color: #f0f1f2; width: 360px">
        <div class="greybar">INVESTMENT DECISIONS</div>
        ...
        <div class="grid_3">
            <div class="t">
                <div>
                    <div class="cPH cPDetR1 cPControlpanelLeft" style="width: 160px; text-align: left;">abc</div>
                    <div class="cPH cPCol1" style="width: 155px; padding-left:10px">Turns Until Market<br />slowdown  ________  death</div>
    ...
    <div class="grid_6 alpha three_product_boxes intern">
        <div class="cPBox_ControlPanel" style="border-bottom: solid thin; border-color: #747d82; width: 200px">
        ...
        <div class="cPBox_ControlPanel" style="border-bottom: solid thin; border-left: solid thin; border-color: #747d82;width:155px">
             <div ng-repeat="p in data_playerproduct">                 
                 <div>                     
                     <div ngm-if='p.y >=1' class="cPH cPControlpanelRight " style="width: 70px; float:left">{{p.marketLifeTimeUp}}</div> <%--turnfield--%>
                     <div ngm-if='p.y <1' class="cPH cPControlpanelRight" style="width: 70px; float:left">-</div>
                     <div class="cPH cPControlpanelRight" style="width: 70px;float:left">{{p.marketLifeTimeDown + p.marketLifeTimeUp}}</div>
                 </div>
             </div>
        </div>
